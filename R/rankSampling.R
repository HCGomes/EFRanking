...
calculateRankSampling <- function(dataset, weights, featuresNames,weightPerGroup, cutOff=-1){
    rank<-matrix(ncol=1,nrow=ncol(dataset[,featuresNames]), dimnames= list(featuresNames,c("Weight")))
